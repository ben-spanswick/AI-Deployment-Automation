...
COPY src/dashboard-unified.py /app/dashboard.py
COPY examples/api-docs/chromadb-info.html /app/chromadb-info.html
COPY examples/api-docs/ollama-info.html /app/ollama-info.html
